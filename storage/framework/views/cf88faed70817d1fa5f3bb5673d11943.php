...
<div style="overscroll-behavior: none;">
      ...
      >
        ...
        <div class="my-3 text-green-100 font-bold text-lg tracking-wide"><?php echo e($user->name); ?></div>
        <!-- 3 dots -->
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
      ...
      <div class="mt-20 mb-16">
        ...
        <!--[if BLOCK]><![endif]--><?php if($message['sender'] != auth()->user()->name): ?>
        <div class="clearfix w-4/4">
          <div
            class="bg-gray-300 mx-4 my-2 p-2 rounded-lg inline-block"
          ><b><?php echo e($message['sender']); ?> : </b><?php echo e($message['message']); ?></div>
        </div>
        <?php else: ?>
        <div class="clearfix w-4/4">
            <div class="text-right">
                <p class="bg-green-300 mx-4 my-2 p-2 rounded-lg inline-block"><?php echo e($message['message']); ?> <b>: You</b></p>
            </div>
        </div>
...
<?php /**PATH C:\Users\azizd\Desktop\laravel-reverb-chat-app\resources\views/livewire/chat-component.blade.php ENDPATH**/ ?>